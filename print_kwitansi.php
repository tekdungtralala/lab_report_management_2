...
// -----------------------------------------------------------------------------
$sql = "SELECT r.*, p.kode_plg as kode_name, p.nama as person_name, p.alamat as person_address, p.id as person_id FROM pps r, pelanggan p, officer o WHERE p.id = r.id_person and r.state = 4 and r.officer_id = o.id and r.id = " . $_GET['id'];
...
if ($result->num_rows > 0) {
		...
		$html.= "Total Biaya : Rp. " . $row["total_price"];$html.= '<br/>';
...
$pdf->Write(0, 'Suherman', '', 0, 'R', true, 0, false, false, 0);
$pdf->Write(0, 'Administrasi', '', 0, 'R', true, 0, false, false, 0);
